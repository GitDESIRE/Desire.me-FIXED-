...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/styles.v10.css')}}">
    <link rel="stylesheet" href="{{asset('assets/css/swiper-bundle.v2.css')}}">
    <link rel="stylesheet" href="{{asset('assets/css/timeline.css')}}">
    <link rel="stylesheet" href="{{asset('assets/css/cursor.v2.css')}}">
...
<script src="{{asset('assets/js/custom-cursor.v6.js')}}"></script>
