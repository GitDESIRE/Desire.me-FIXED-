            ...
            <div class="content">
                <div class="content-box">
                    ...
                    <ul>
                        ...
                        <p>Возможность оптимизировать финансовые вложения в разработку, быстро протестировать новые идеи и в дальнейшем позволить сотрудникам самостоятельно настраивать сайт или приложение</p>
                    </ul>
                </div>
                <div class="content-box">
                    <h2 class="subTitle">что мы сделаем</h2>
                    <ul>
                        <li>Выясним ваши цели, запросы и пожелания по сайту или приложению</li>
                        <li>Проведём анализ целевой аудитории, чтобы готовый продукт был ориентирован именно на ваших будущих клиентов</li>
                        <li>Выполним анализ конкурентов, ведь благодаря исследованию ваших прямых конкурентов мы сможем выявить те элементы, которые будут наиболее эффективны на вашем сайте или приложении</li>
                        <li>Создадим структуру и дизайна вашего сайта или приложения</li>
                        <li>Разработаем сайт или приложение с использованием NoCode инструментов и его тестированием</li>
                ...
                <div class="content-box">
                    ...
                    <ul>
                        <li>Функционирующие сайт или приложение, способные конвертировать лиды и реализовывать вашу изначальную идею</li>
                        <li>Поддержку от наших специалистов в виде пошаговой инструкции по самостоятельной настройке и изменению/добавлению контента</li>
                        <li>Месяц гарантийного срока, в течение которого вы можете спокойно обратиться к нашей компании за помощью в настройке или исправлении</li>
                        <li>Отличного партнёра в виде компании Desire, который знает особенности вашего приложения или сайта и всегда готов помочь вашему бизнесу расти и дальше!</li>
                    </ul>
                </div>
                <div class="content-box">
