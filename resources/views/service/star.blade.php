            ...
            <div class="wrapper">
                <div class="content">
                    <div class="seo-banner-top">
                        ...
                        <p class="seo-banner-section"><a href="#">Услуги</a> / <a href="#">Комплексные тарифы</a> / Комплексное решение «START»</p>
                    </div>
                    <div class="seo-banner-bottom">
                        <p class="seo-banner-description">Лучшее предложение для любого бизнеса на пути в e-commerce.</p>
