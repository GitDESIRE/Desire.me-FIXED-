            ...
            <form class="newProject_form" name="newProject_form">
                <div class="inputsBox">
                    ...
                    <div class="inputsBox_bot">
                        ...
                        <label for="tarig"><span class="label-title">Тариф</span></label>
                        <input name="tarif" id="tarif" placeholder="тариф" />
                    </div>
                </div>
                ...
                <div class="buttonsBox">
                    ...
                    <button class="submit-button"><a href="https://t.me/desire_manager">Отправить</a></button>
                </div>
                <div class="agreement_box">
                    <label class="checkbox-label">
                        ...
                        <span class="rights">Даю согласие на обработку
                            <a href="{{asset('assets/Privacy politic.pdf')}}" class="agreementData-link">Персональных данных</a></span>
                    </label>
                </div>
            </form>
        </section>
