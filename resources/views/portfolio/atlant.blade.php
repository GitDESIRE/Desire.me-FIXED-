    ...
    <div class="wrapper project-wrapper">
      <div class="seo-banner-top">
        ...
        <div class="main-link">
                ...
                <span class="main-link__span">Трекер задач ATLANT</span>
              </div>
      </div>
  ...
  <section class="project-screens">
    ...
    <div class="project-info">
      ...
      <div class="wrapper screen-wrapper">
        ...
        <div class="text-content">
          <p>Задаче можно задавать приоритет, дату и время выполнения, поместить её в конкретный блок задач (работа, личное, контакты, покупки и т.п.)</p>
        </div>
      </div>
      <div class="wrapper screen-wrapper">
        <div class="text-content">
          <h2 class="project-subtitle">Расписание</h2>
          <p>На экране расписания удобный просмотр задачи на текущий день, неделю и месяц. Любую задачу можно открыть и скорректировать информацию по ней.</p>
        </div>
        <div class="image-content">
      ...
      <div class="wrapper screen-wrapper">
        ...
        <div class="text-content">
          ...
          <p>Для удобства пользователей на экране списков задачи разделяются на блоки.</p>
        </div>
      </div>
      <div class="wrapper screen-wrapper">
        <div class="text-content">
