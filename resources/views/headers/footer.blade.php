          ...
          <div class="footer-social">
            <ul class="footer-bottom-list">
              <li class="footer-bottom-item">
                <a href="/team" class="footer-bottom-link">О нас</a>
              </li>
              <li class="footer-bottom-item">
                <a href="/promotion" class="footer-bottom-link">Продвижение</a>
              </li>
              <li class="footer-bottom-item">
                <a href="/design" class="footer-bottom-link"
                  >Дизайн</a
                >
              </li>
              <li class="footer-bottom-item">
                <a href="/dev" class="footer-bottom-link"
                  >Разработка</a
                >
              </li>
              <li class="footer-bottom-item">
                <a href="/complex-tariffs" class="footer-bottom-link"
            ...
            <ul class="footer-list footer-list__middle">
              <li class="footer-item-title">Контакты</li>
              <li class="footer-item">
                <a href="mailto:desirecompany@yandex.ru" class="mail-link"
                  >desirecompany@yandex.ru</a
                >
              </li>
              <li class="footer-item footer-item-no-focus">
                telegram-менеджер:
              </li>
              <li class="footer-item">
                <a
                  href="https://t.me/desire_manager"
                  class="footer-link"
                  rel="nofollow"
                  target="_blank"
                  >@desire_manager</a
